...
own version and its own tag (`@midstem/chronous@1.0.0`,
`@midstem/chronous-react@1.0.1`), and this script is what picks the package,
writes the version and creates the tagged GitHub release — so nobody has to type
a tag by hand and get it wrong.

...
colour palette, no helper functions — the range, the events, and one component
that walks the `CalendarLayout` and lays it out. Under half the lines of the full

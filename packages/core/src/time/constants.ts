...
export const MISSING_TEMPORAL_MESSAGE =
  'Temporal is not available in this runtime. Install temporal-polyfill and import temporal-polyfill/global before using Chronous, or use a runtime with native Temporal. See https://github.com/midstem/chronous/tree/main/packages/core#temporal'
